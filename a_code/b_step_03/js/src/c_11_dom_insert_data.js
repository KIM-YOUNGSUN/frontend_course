...
var data = [
...

  {
    ...
    bgImg:'../multi/img/drink.jpg',
    bgNarr:'drink 이미지에 설명 작성'
  },
  ...
  
  {
    ...
    bgImg:'../multi/img/shrimp.jpg',
    bgNarr:'shrimp image 설명'
  }, 
  ...
  
  {
    ...
    contents:'Lorem ipsum dolor sit amet consectetur adipisicing elit.' ,
    bgImg:'../multi/img/shrimp.jpg',
    bgNarr:'shrimp 이미지에 대한 간략한 설명'
  }
];
// ------------------------------------------
// 시나리오 :
// .card 내부에 li요소 삽입
// 별도의 data 객체를 만들어서 해당하는 내용이 li에 첨부되게 진행
...
} // append를 쓴 이유: innerHTML은 중복을 허용하지 않고 내부 자료를 삭제 후 덮어 씌우지만 append는 기존 자료에 추가가 됨
