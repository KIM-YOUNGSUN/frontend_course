...
// form : <form action="어디에 보낼까?" method="보안"></form> 
// method : GET(단순히 자료를 요청하여 가져오는 기술), POST(생성)

var xhr = new XMLHttpRequest(); // 외부에서 자료 가져오는 것
var method = 'GET'; 
var url = '../data/sample.txt';
var async = true; // 비동기 승인(비동기 처리 할 것인가?)

// 자료를 요청
// xhr.open(method방식, 처리할 파일 경로, 비동기 승인 여부)
