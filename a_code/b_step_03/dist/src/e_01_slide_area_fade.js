...
// --------------------------------------------------
// 시나리오
// 다음 버튼 클릭시 - 'fadeOut'/(fadeIn) 기능을 이용하여, 이미지 변경
// 1. 현재 보이는 이미지(z-index:10)에 버튼 클릭시 보이는 이미지 바로 뒤에 이미지가 나타나게 만들기
...
viewLi[countIndex].style.transition = `opacity${timed*2}ms ${cssFn}`;
// -----------------------------------------------------
// 함수
