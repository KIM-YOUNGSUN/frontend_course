...
const tablet = 'screen and (min-width:600px) and (max-width:767px)';
const laptop = 'screen and (min-width:768px) and (max-width:1439)';
const pc = 'screen and (max-width:1440px)';

mobile.addEventListener('change', e=>{
  console.log('현재 mobile 규격에서 무언가 변화했습니다.');
});

tablet.addEventListener('change', e=>{
  console.log('현재 tablet 규격에서 무언가 변화했습니다.');
});

laptop.addEventListener('change', e=>{
  console.log('현재 laptop 규격에서 무언가 변화했습니다.');
});

pc.addEventListener('change', e=>{
  console.log('현재 pc 규격에서 무언가 변화했습니다.');
});